...
LOCAL_SRC_FILES += $(call all-java-files-under, ../IphoneCamera/src)

LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/res packages/apps/IphoneCamera/res
...
include $(call all-makefiles-under, ../IphoneCamera)
