...
public class TrimVideo extends Activity implements
    ...
    /* End: added by yuanhuaewei 20130907 */
	...
	/* Begin: added by yuanhuawei 20130907 */
	mCancelBtn = (Button) findViewById(R.id.iphone_video_top_cancel_btn);
	mCancelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                 TrimVideo.this.onBackPressed();
            }
        });
	mSaveBtn = (Button) findViewById(R.id.iphone_video_trim_top_save_btn);
