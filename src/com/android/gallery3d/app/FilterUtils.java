...
public class FilterUtils {
    ...
    public static final int CLUSTER_BY_ICLOUD = 3;//added by scq
    public static final int CLUSTER_BY_MOMARY = 4;//added by scq
	...
	/*Begin: added by scq 20161201*/
        setMenuItemApplied(actionBar, CLUSTER_BY_ICLOUD,
                (ctype & CLUSTER_BY_ICLOUD) != 0, (ccurrent & CLUSTER_BY_ICLOUD) != 0);
        setMenuItemApplied(actionBar, CLUSTER_BY_MOMARY,
                (ctype & CLUSTER_BY_MOMARY) != 0, (ccurrent & CLUSTER_BY_MOMARY) != 0);
