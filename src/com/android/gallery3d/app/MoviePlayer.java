...
//    };
    ...
    public void refreshMovieTitle(String title){
    	mController.refreshTopBarTitle(title);
    }
    ...
    private void doStartVideo(boolean enableFasten, int position, int duration) {
        ...
        /* Begin: added by yuanhuawei 20130909 */
        if(((AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE)).isMusicActive()){
        ...
        /* End: added by yuanhuawei 20130909 */
