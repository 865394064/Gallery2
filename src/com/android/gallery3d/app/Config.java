...
final class Config {
    public static class AlbumSetPage {
	   ...
	   slotViewSpec.slotWidth = r.getDimensionPixelSize(R.dimen.albumset_slot_width);
	   slotViewSpec.slotHeight= r.getDimensionPixelSize(R.dimen.albumset_slot_height);
	   slotViewSpec.rs = r;
    ...
    public static class AlbumPage {
	   ...
	   /* Begin: added by yuanhuawei 20130808*/
	   slotViewSpec.slotWidth = r.getDimensionPixelSize(R.dimen.album_slot_width);
	   slotViewSpec.slotHeight= r.getDimensionPixelSize(R.dimen.album_slot_height);
	   /* End: added by yuanhuawei 20130808*/
        }
    }
