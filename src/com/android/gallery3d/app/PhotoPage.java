...
public class PhotoPage extends ActivityState implements
        ...
        IphonePhotoTopBar.Delegate,
        IphonePhotoBottomBar.Delegate,
        IphonePhotoBottomSharePopWindow.Delegate,
        IphoneBottomDeletePopWindow.Delegate{ //added by yuanhuawei 20130815
   ...
   /* End: added by yuanhuawei 20130815*/
    ...
    /* Begin: added by yuanhuawei 20130815 */
    private IphonePhotoTopBar mPhotoTopBar;
    private IphonePhotoBottomBar mPhotoBottomBar;
    private IphonePhotoBottomSharePopWindow mPhotoSharePopWindow;
    private IphoneBottomDeletePopWindow mBottomDeletePopWindow;
    /* End: added by yuanhuawei 20130815*/
	//zzd add 20140509 begin
	private boolean mEnableSwipeToCamera = false;
	//zzd add 20140509 end
    ...
    protected int getBackgroundColorId() {
        ...
        /* Begin: added by yuanhuawei 20130924 */
		if(mAppBridge != null && mCurrentIndex == 0){
			return R.color.camera_background;
        }
        if(!mShowBars){
	         return R.color.photo_fullscreen_background;
        }
        /* End: added by yuanhuawei 20130924 */
    ...
    private final GLView mRootPane = new GLView() {
       ...
       @Override
        protected void renderBackground(GLCanvas canvas) {
            canvas.clearBuffer(GalleryUtils.intColorToFloatARGBArray(
    ...
    public void onCreate(Bundle data, Bundle restoreState) {
        ...
        if (mSetPathString != null) {
		    ...
		    //zzd add if(mEnableSwipeToCamera) 20140509 begin
		    	if(mEnableSwipeToCamera){
                    		mSetPathString = "/filter/empty/{"+mSetPathString+"}";
		    	}
                    //zzd add if(mEnableSwipeToCamera) 20140509 end
                }
            ...
            }else if (/*zzd add 20140509 begin{*/ mEnableSwipeToCamera && /*}zzd add 20140509end*/inCameraRoll && GalleryUtils.isCameraAvailable(mActivity)) {
	  ...
	  /* Begin: added  by yuanhuawei 20130815 */
	  mTotalCount =  mMediaSet.getMediaItemCount();
	  /* End: added by yuanhuawei 20130815*/
            ...
            pda.setDataListener(new PhotoDataAdapter.DataListener() {
			 ...
			 /* Begin: added by yuanhuawei for test 20130903 */
			 RelativeLayout galleryRoot = (RelativeLayout) ((Activity) mActivity)
               			 .findViewById(mAppBridge != null ? R.id.camera_app_root_content : R.id.gallery_root);
			 galleryRoot.setVisibility(View.VISIBLE);
			 /* End: added by yuanhuawei for test 20130903 */
			 ...
			 /* End: added by yuanhuawei for test 20130903 */
		      ...
		      /* Begin: added  by yuanhuawei 20130815 */
		      mTotalCount =  mMediaSet.getMediaItemCount();
		      if(mPhotoTopBar != null){
			if(mHasCameraScreennailOrPlaceholder){
				//mPhotoTopBar.setPhotoTiltle(mCurrentIndex, mTotalCount - 1);
				setPhotoDetails();
			}else{
				//mPhotoTopBar.setPhotoTiltle(mCurrentIndex + 1, mTotalCount);
				setPhotoDetails();
			}
		      }
		       /* End: added by yuanhuawei 20130815*/
        ...
        RelativeLayout galleryRoot = (RelativeLayout) ((Activity) mActivity)
                .findViewById(mAppBridge != null ? R.id.camera_app_root_content : R.id.gallery_root); //changed by yuanhuawei for test from R.id.content to R.id.camera_app_root_content 20130903
        if (galleryRoot != null) {
	   /* Begin: added by yuanhuawei for test 20130903 */
	   if (mAppBridge != null && mCurrentIndex == 0
	   ...
	   /* End: added by yuanhuawei for test 20130903 */
            if (mSecureAlbum == null) {
                //mBottomControls = new PhotoPageBottomControls(this, mActivity, galleryRoot); //deleted by yuanhuawei 20130815
            }
	   /* Begin: added by yuanhuaewi 20130815 */
	   mPhotoTopBar = new IphonePhotoTopBar(this, mActivity, galleryRoot);
	   mPhotoBottomBar = new IphonePhotoBottomBar(this, mActivity, galleryRoot);
	   /* End: added by yuanhuawei 20130815*/

	  //Begin: zzd add for Bug3113 20140510
	boolean isSingleItemOnly = data.getBoolean("SingleItemOnly", false);
	boolean mDisableEditShareAndDelete = data.getBoolean("DisableEditShareAndDelete", false);
	if(isSingleItemOnly){
		if(mDisableEditShareAndDelete){
			if(mPhotoTopBar!=null){
				mPhotoTopBar.setViewMmsMode(true);
			}
			if(mPhotoBottomBar!=null){
				mPhotoBottomBar.setViewMmsMode(true);
			}
		}
	}
   ...
   /* Begin: added by yuanhuawei 20130815 */
   /*begin: add by scq 20161028*/
    	private Handler mTitleHander = null;//add by scq
    	private Runnable mTitleRunnable = null;
	public void setPhotoDetails(){
		if(mTitleHander == null){
			mTitleHander = new Handler();
		}
		if(mTitleRunnable == null){
			mTitleRunnable = new Runnable() {//add by scq
	                @Override
	                public void run() {
				showDetails();   
				setTitleTime(mDetailsHelper.getPhotoTime());//add by scq
				hideDetails();
	                }
			};
		}
        	mTitleHander.postDelayed(mTitleRunnable, 650);//add by scq
	}
	private void setTitleTime(String time){
		if(time != null) {
			String[] timearray = time.split("[ ]");
			mPhotoTopBar.setPhotoTiltle(timearray[1], timearray[2]);
	     		//mPhotoTopBar.mGalleryTitile.setText(timearray[1]);//add by scq
	     		//mPhotoTopBar.mGalleryTitileTime.setText(timearray[2]);//add by scq
			//android.provider.Settings.System.putInt(mActivity.getContentResolver(),"gallery_setwallpaper_flag",0);
		}else{
			mPhotoTopBar.setPhotoTiltle(mActivity.getResources().getString(R.string.iphone_bottom_navigation_bar_albums_string), null);
			//android.provider.Settings.System.putInt(mActivity.getContentResolver(),"gallery_setwallpaper_flag",1);
	     		//mPhotoTopBar.mGalleryTitile.setText(R.string.iphone_bottom_navigation_bar_albums_string);//add by scq
	     		//mPhotoTopBar.mGalleryTitileTime.setVisibility(View.GONE);//add by scq
		}
	}
/*end: add by scq 20161028*/
   ...
   public void onPhotoTopBarControlClicked(int control){
   	switch(control) {
            case R.id.iphone_photo_top_details_btn://iphone_photo_top_edit_btn: //modify by scq
	       android.util.Log.d(TAG, "onPhotoTopBarControlClicked ** edit_btn");
		if (mShowDetails) {
                hideDetails();
              } else {
                showDetails();  
	       ...
	       if (mCurrentPhoto.getMediaType() == MediaObject.MEDIA_TYPE_VIDEO 
                ...
                return;
            case R.id.iphone_photo_top_cancel_btn:
	       android.util.Log.d(TAG, "onPhotoTopBarControlClicked ** cancel_btn");
	       if(mPhotoSharePopWindow != null){ 
		   	mPhotoSharePopWindow.cleanup();
			mPhotoSharePopWindow = null;
		}
	       if(mPhotoTopBar != null) mPhotoTopBar.setCancelBtnVisible(false);
                return;
            case R.id.iphone_photo_top_back_btn:
                android.util.Log.d(TAG, "onPhotoTopBarControlClicked ** back_btn");
                  /**Begin: modified by lzp for bug [2879]**/
                if(mActivity != null)
		...
		onBackPressed();
	       	...
	       	mActivity.getStateManager().finishState(this, false);
                ...
                /**End: modified by lzp for bug [2879]**/
                return;
            default:
                return;
        }
   ...
   public void refreshPhotoTopBarControlsWhenReady(){
   	if (mPhotoTopBar == null) {
        ...
        mPhotoTopBar.refresh();
        mPhotoTopBar.setCancelBtnVisible(false);
        /*
        MediaObject currentPhoto = mCurrentPhoto;
   ...
   public void onPhotoBottomBarControlClicked(int control){
   	switch(control) {
            case R.id.iphone_photo_bottom_edit:
	       android.util.Log.d(TAG, "onPhotoBottomBarControlClicked ** edit");
	       if (mModel == null) return;
	        refreshHidingMessage();
	        MediaItem current = mModel.getMediaItem(0);
	        ...
	        if (mIsStereoDisplaySupported && StereoHelper.isStereoImage(current)) {
                ...
                launchPhotoEditor();
                return;
            case R.id.iphone_photo_bottom_share:
	       android.util.Log.d(TAG, "onPhotoBottomBarControlClicked ** share");
	       RelativeLayout galleryRoot = (RelativeLayout) ((Activity) mActivity)
	                .findViewById(mAppBridge != null ? R.id.camera_app_root_content : R.id.gallery_root);
	        if (galleryRoot != null) {
		      mPhotoSharePopWindow= new IphonePhotoBottomSharePopWindow(this, mActivity, galleryRoot);
		      mPhotoSharePopWindow.setShareIntent(createShareIntent(mCurrentPhoto));
	        	}
	       refreshPhotoSharePopBottomControlsWhenReady();
	       if(mPhotoTopBar != null) mPhotoTopBar.setCancelBtnVisible(true);
                return;
            case R.id.iphone_photo_bottom_delete:
                android.util.Log.d(TAG, "onPhotoBottomBarControlClicked ** delete");
   ...
   public void onPhotoSharePopBottomControlClicked(int control){
	...
	String confirmMsg = null;
   	...
   	switch(control) {
            case R.id.iphone_photo_share_pop_action_to_slideshow:
	       android.util.Log.d(TAG, "onPhotoSharePopBottomControlClicked ** slideshow");
	       Bundle data = new Bundle();
                ...
                return;
	   case R.id.iphone_photo_share_pop_action_to_contacts:
	       android.util.Log.d(TAG, "onPhotoSharePopBottomControlClicked ** contacts");
	       setAsContactsOrWallpaper(true);
                return;
	   case R.id.iphone_photo_share_pop_action_to_wallpaper:
	       android.util.Log.d(TAG, "onPhotoSharePopBottomControlClicked ** wallpaper");
	       setAsContactsOrWallpaper(false);
                return;
	   case R.id.iphone_photo_share_pop_action_to_edit:
	       android.util.Log.d(TAG, "onPhotoSharePopBottomControlClicked ** edit");
	       if (mIsStereoDisplaySupported && StereoHelper.isStereoImage(current)) {
                    Log.i(TAG,"onItemSelected:for stereo image, show dialog");
                    showConvertEditDialog(current);
                    return;
                ...
                launchPhotoEditor();
                return;
	   case R.id.iphone_photo_share_pop_action_to_rotate_left:
	       android.util.Log.d(TAG, "onPhotoSharePopBottomControlClicked ** rotate_left");
	       performClickRotate(true);
                return;
	   case R.id.iphone_photo_share_pop_action_to_rotate_right:
	       android.util.Log.d(TAG, "onPhotoSharePopBottomControlClicked ** rotate_right");
	       performClickRotate(false);
                return;
	   case R.id.iphone_photo_share_pop_action_to_clip:
	       android.util.Log.d(TAG, "onPhotoSharePopBottomControlClicked ** clip");
	       if (mIsStereoDisplaySupported && StereoHelper.isStereoImage(current)) {
                    Log.i(TAG,"onItemSelected:for stereo image, show dialog");
   ...
   public void refreshPhotoSharePopBottomControlsWhenReady(){
      ...
      private void setAsContactsOrWallpaper(boolean isContacts){
	       ...
	       mSelectionManager.deSelectAll();
                mSelectionManager.toggle(currentPath);
  ...
  public void performClickRotate(boolean isRotateLeft){
   	int menuItemId = isRotateLeft ? R.id.action_rotate_ccw : R.id.action_rotate_cw;
	if(mMenuExecutor != null){
		if (mModel == null) return;
	        ...
	        mSelectionManager.deSelectAll();
                 mSelectionManager.toggle(currentPath);
		mMenuExecutor.onMenuClicked(menuItemId, null, false, true);
	}
   }
   ...
   @Override
	...
	if (mBottomDeletePopWindow == null) {
        ...
        mBottomDeletePopWindow.setHeaderVisible(false);
    }

   public void performClickDelete(){
         String confirmMsg = null;
	...
	confirmMsg = mActivity.getResources().getQuantityString(
		...
		if (mModel == null) return;
	       ...
	       mPhotoView.startDeleteAnimation();
	        int currentIndex = mModel.getCurrentIndex();
	        Path currentPath = current.getPath();
	        mSelectionManager.deSelectAll();
                 mSelectionManager.toggle(currentPath);
		mMenuExecutor.onMenuClicked(R.id.action_delete, mConfirmDialogListener, false, false);
	}
         notifyDeletePopCleanUp();
   }
   /* End: added by yuanhuawei 20130815*/
...
//            }, mActivity);
    ...
    private void showBars() {
        ...
        mShowBars = true;
        mOrientationManager.unlockOrientation();
        //mActionBar.show(); //deleted by yuanhuawei 20130815
        ...
        if(mPhotoTopBar != null) {
		if(mPhotoSharePopWindow != null){
			mPhotoTopBar.setCancelBtnVisible(true);
		}else{
			mPhotoTopBar.setCancelBtnVisible(false);
		}
		mPhotoTopBar.show();
	}
        if(mPhotoBottomBar != null) mPhotoBottomBar.show();
        if(mRootPane != null) mRootPane.invalidate();
        /* End: added by yuanhuawei 20130815*/
    }
    ...
    private void hideBars() {
        ...
        refreshBottomControlsWhenReady();
        /* Begin: added by yuanhuawei 20130815 */
        if(mPhotoTopBar != null) mPhotoTopBar.hide();
        if(mPhotoBottomBar != null) mPhotoBottomBar.hide();
        if(mRootPane != null) mRootPane.invalidate();
        /* End: added by yuanhuawei 20130815*/
    }
    ...
    private void refreshHidingMessage() {
        ...
        if (!mIsMenuVisible && !mPhotoView.getFilmMode()) {
            //mHandler.sendEmptyMessageDelayed(MSG_HIDE_BARS, HIDE_BARS_TIMEOUT); //deleted by yuanhuawei 20130907
        }
    }
    ...
    protected void onBackPressed() {
        /*Begin added by xujia 20140507*/
        refreshPhotoTopBarControlsWhenReady();
        refreshPhotoBottomBarControlsWhenReady();
        if(mPhotoSharePopWindow!= null){
		mPhotoSharePopWindow.cleanup();
        		mPhotoSharePopWindow = null;
        	}
...
//            mActivity.getGLRoot().setStereoMode(false, true);
        ...
        refreshBottomControlsWhenReady();
        /* Begin: added by yuanhuawei 201308105*/
        refreshPhotoTopBarControlsWhenReady();
        refreshPhotoBottomBarControlsWhenReady();
        if(mPhotoSharePopWindow!= null){
		mPhotoSharePopWindow.cleanup();
    ...
    protected void onDestroy() {
        ...
        /* Begin: added by yuanhuawei 20130815*/
        if(mPhotoTopBar != null) mPhotoTopBar.cleanup();
        if(mPhotoBottomBar != null) mPhotoBottomBar.cleanup();
        /* End: added by yuanhuawei 20130815*/
    ...
    private class MyDetailsSource implements DetailsSource {
        ...
        public MediaDetails getDetails() {
            if(mModel.getMediaItem(0)==null || mModel.getMediaItem(0).getDetails() == null){  //added by gaojunbin
                  return null;
              }
...
Log.i(TAG,"showStereoShareDialog:start new intent!");
    ...
    private void updateActionBarTitle() {
	   ...
	   if(mPhotoTopBar != null){
	   	if(mMediaSet != null){
	   		mPhotoTopBar.setBackBtnText(mMediaSet.getName());
			if(mHasCameraScreennailOrPlaceholder){
				//mPhotoTopBar.setPhotoTiltle(mCurrentIndex, mTotalCount - 1);
				setPhotoDetails();
			}else{
	   ...
	   /* End: added by yuanhuawei 201305815*/
        } else {
            mActionBar
