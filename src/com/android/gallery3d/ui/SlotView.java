...
public class SlotView extends GLView {
    ...
    private static final boolean WIDE = false; //changed by yuanhuawei from true to false 20130808
    ...
    private int mOverscrollEffect = OVERSCROLL_SYSTEM; //changed by yuanhuawei from OVERSCROLL_SYSTEM to OVERSCROLL_SYSTEM 20130808
    ...
    protected void onLayout(boolean changeSize, int l, int t, int r, int b) {
        android.util.Log.d(TAG, "onLayout *** changeSize = " + changeSize
			+ " *** l = " + l
			+ " *** t = " + t
			+ " *** r = " + r
			+ " *** b = " + b
    ...
    public class Layout {
	   ...
	   android.util.Log.d(TAG, "setSlotCount *** slotCount = " + slotCount);
	   ...
	   android.util.Log.d(TAG, "initLayoutParameters *** mUnitCount = " + mUnitCount
	  	+ " *** mSlotCount = " + mSlotCount
	  	+ " *** availableUnits = " + availableUnits
	  	+ " *** count = " + count
	  	+ " *** mContentLength = " + mContentLength
	  	+ " *** majorLength = " + majorLength
	  	+ " *** usedMinorLength = " + usedMinorLength
		...
		mSlotGap = mSpec.slotGap;
	       ...
	       /* End: changed by yuanhuawei 20130808*/
                mSlotWidth = /*Spec.slotWidth*/(mSpec.rs!=null?mSpec.rs.getDimensionPixelSize(com.android.gallery3d.R.dimen.albumset_slot_width):mSpec.slotWidth);//modified by lzp
	   ...
	   android.util.Log.d(TAG, "setSize ** width = " + width
	   	+ " ** height = " + height);
            mWidth = width;
            mHeight = height;
            initLayoutParameters();
