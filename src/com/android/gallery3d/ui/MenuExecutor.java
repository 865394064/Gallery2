...
public class MenuExecutor {
    ...
    public void onMenuClicked(int action, ProgressListener listener,
        ...
        android.util.Log.d(TAG, "onMenuClicked *** action = " + action
			+ " *** title = " + title
			+ " *** listener = " + listener
			+ " *** waitOnStop = " + waitOnStop
   ...
   public static ArrayList<Integer> getVisibleItems(Menu menu){
   	ArrayList<Integer> visibleList = new ArrayList<Integer>();
	if(((MenuItem)menu.findItem(R.id.action_delete)).isVisible() && ((MenuItem)menu.findItem(R.id.action_delete)).isEnabled()){
		visibleList.add(R.id.action_delete);
	}
	if(((MenuItem)menu.findItem(R.id.action_rotate_ccw)).isVisible() && ((MenuItem)menu.findItem(R.id.action_rotate_ccw)).isEnabled()){
		visibleList.add(R.id.action_rotate_ccw);
	}
	if(((MenuItem)menu.findItem(R.id.action_rotate_cw)).isVisible() && ((MenuItem)menu.findItem(R.id.action_rotate_cw)).isEnabled()){
		visibleList.add(R.id.action_rotate_cw);
	}
	if(((MenuItem)menu.findItem(R.id.action_crop)).isVisible() && ((MenuItem)menu.findItem(R.id.action_crop)).isEnabled()){
		visibleList.add(R.id.action_crop);
	}
	if(((MenuItem)menu.findItem(R.id.action_share)).isVisible() && ((MenuItem)menu.findItem(R.id.action_share)).isEnabled()){
		visibleList.add(R.id.action_share);
	}
	if(((MenuItem)menu.findItem(R.id.action_setas)).isVisible() && ((MenuItem)menu.findItem(R.id.action_setas)).isEnabled()){
		visibleList.add(R.id.action_setas);
	}
	if(((MenuItem)menu.findItem(R.id.action_show_on_map)).isVisible() && ((MenuItem)menu.findItem(R.id.action_show_on_map)).isEnabled()){
		visibleList.add(R.id.action_show_on_map);
	}
	if(((MenuItem)menu.findItem(R.id.action_edit)).isVisible() && ((MenuItem)menu.findItem(R.id.action_edit)).isEnabled()){
		visibleList.add(R.id.action_edit);
	}
	if(((MenuItem)menu.findItem(R.id.action_details)).isVisible() && ((MenuItem)menu.findItem(R.id.action_details)).isEnabled()){
		visibleList.add(R.id.action_details);
	}
	if(((MenuItem)menu.findItem(R.id.action_import)).isVisible() && ((MenuItem)menu.findItem(R.id.action_import)).isEnabled()){
		visibleList.add(R.id.action_import);
	}
	if(((MenuItem)menu.findItem(R.id.action_print)).isVisible() && ((MenuItem)menu.findItem(R.id.action_print)).isEnabled()){
		visibleList.add(R.id.action_print);
	}
	if(((MenuItem)menu.findItem(R.id.action_protect_info)).isVisible() && ((MenuItem)menu.findItem(R.id.action_protect_info)).isEnabled()){
		visibleList.add(R.id.action_protect_info);
	}
	return visibleList;
   }
