...
public class AlbumSetSlotRenderer extends AbstractSlotRenderer {
    ...
    public int renderSlot(GLCanvas canvas, int index, int pass, int width, int height) {
        ...
        if(entry != null) {//added by lzp
        	renderRequestFlags |= renderContent(canvas, entry, width, height-30);
        	renderRequestFlags |= renderLabel(canvas, entry, width, height-30);
        	renderRequestFlags |= renderOverlay(canvas, index, entry, width, height-30);     // mod by gaojunbin 
         }
