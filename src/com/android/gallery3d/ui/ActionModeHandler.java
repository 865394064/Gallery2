...
public class ActionModeHandler implements Callback, PopupList.OnPopupItemClickListener {
    ...
    public void startActionMode() {
        ...
        mActionMode = a.startActionMode(this); //deleted by yuanhuawei 20130827
        View customView = LayoutInflater.from(a).inflate(
                R.layout.action_mode, null);
        mActionMode.setCustomView(customView); //deleted by yuanhuawei 20130827
    ...
    public void finishActionMode() {
        mActionMode.finish(); //deleted by yuanhuawei 20130827
   ...
   public ArrayList<Integer> getVisibleMenuItems(){
   	//mSharePanoramaMenuItem = mMenu.findItem(R.id.action_delete);
   	return MenuExecutor.getVisibleItems(mMenu);
   }
   ...
   public void performClickCrop(){
   	mMenuExecutor.onMenuClicked(R.id.action_crop, null, false, true);
   }
   ...
   public void performClickDelete(){
   	ProgressListener listener = null;
         if (mDeleteProgressListener == null) {
          ...
          listener = mDeleteProgressListener;
	 mMenuExecutor.onMenuClicked(R.id.action_delete, listener, false, true);
   }
   /* End: added by yuanhuawei 20130812*/
