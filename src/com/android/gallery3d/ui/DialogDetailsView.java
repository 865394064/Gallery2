...
public class DialogDetailsView implements DetailsViewContainer {
    ...
    private String photoTime = null;//added by scq
    
   //begin: added by scq
   public void setPhotoTime(String time){
	photoTime = time;
   }
    ...
    private class DetailsAdapter extends BaseAdapter implements AddressResolvingListener {
        ...
        private void setDetails(Context context, MediaDetails details) {
            for (Entry<Integer, Object> detail : details) {
			   ...
			   setPhotoTime(mItems.get(1));//add by scq
		  ...
		  if(key == MediaDetails.INDEX_DATETIME) {
			setPhotoTime(value);//add by scq
                }
                mItems.add(value);
            }
        }
